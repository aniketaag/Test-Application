...
public class UserValConstants {
	...
	public static final String PHNUMBER_REGEX = "\\d{8}|\\d{10}|(?:\\d{3}-){2}\\d{4}|\\(\\d{3}\\)\\d{3}-?\\d{4}";
	...
	public static final String NAME_LENGTH_MSG = "Only upto 20 charecters are allowed";
	public static final String STATUS_MSG = "Invalid Status";
}
